...
_state["errors"]=12;
_state["decision"]="";
_state["decisionScore"]=0;
_state["afterCpu"]=0;
_state["afterMemory"]=0;
_state["rootCause"]="";
_state["causalChain"]="";
_state["impactList"]="";
_state["severity"]="";
_state["showResult"]=false;
...
async function action_runDecision(){
  _set("decision",scale);
  _set("decisionScore",30);
  _set("afterCpu",_get("cpu") - 25);
  _set("afterMemory",_get("memory") - 10);
  _set("rootCause",memory_leak);
  _set("causalChain",api_error > service_failure > memory_leak);
  _set("impactList",db_slow, api_error, user_complaint);
  _set("severity",high);
  _set("showResult",true);
}
window.action_runDecision=action_runDecision;
